...
//    public Weekday mondayLA = new Weekday(21, 52, "Sunday");             //Exact schedule should be Monday 8:30
...
//    public Weekday mondayPF = new Weekday(21, 53, "Sunday");            //Exact schedule should be Monday 10:30
...
//            q1.setTitle("Pre-lecture PAM")
//                    .setSubmitButton("Done")
//                    .setNotificationTimeout(60*630)         //First PAM stays active until 630 min after the beginning of the lecture
...
//                if(!UserData.Username.equals("/")){
//
//                    if(Scheduler.getSchedule(context, "second_pam1"+UserData.Username) == null){
...
//                    }
//
//                    if(Scheduler.getSchedule(context, "second_pam2"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")){
//                    if(Scheduler.getSchedule(context, "second_pam3"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam4"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam5"+UserData.Username) == null){
...
//                if(!UserData.Username.equals("/")){
//
//                    if(Scheduler.getSchedule(context, "second_pam6"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam7"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam8"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")){
//                    if(Scheduler.getSchedule(context, "second_pam9"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam10"+UserData.Username) == null) {
...
//
//                if(!UserData.Username.equals("/")) {
//                    if(Scheduler.getSchedule(context, "second_pam11"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_pam12"+UserData.Username) == null){
...
//                if(!UserData.Username.equals("/")){
//
//                    if(Scheduler.getSchedule(context, "third_pam1"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam2"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")){
//                    if(Scheduler.getSchedule(context, "third_pam3"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam4"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam5"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")){
//                    if(Scheduler.getSchedule(context, "third_pam6"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam7"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam8"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")){
//                    if(Scheduler.getSchedule(context, "third_pam9"+UserData.Username) == null){
...
//                    }
//
//                    if(Scheduler.getSchedule(context, "third_pam10"+UserData.Username) == null){
...
//
//                if(!UserData.Username.equals("/")) {
//                    if(Scheduler.getSchedule(context, "third_pam11"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "third_pam12"+UserData.Username) == null){
...
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture1"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture2"+UserData.Username) == null){
...
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture3"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture4"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture5"+UserData.Username) == null){
...
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture6"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture7"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture8"+UserData.Username) == null){
...
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture9"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture10"+UserData.Username) == null){
...
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture11"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "first_post_lecture12"+UserData.Username) == null){
...
////                    esmQuickAnswer.setTitle("Survey about the first lecture of Linear Algebra (7/7)");
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture1"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture2"+UserData.Username) == null){
...
////                    esmQuickAnswer.setTitle("Survey about the first lecture of Programming Fundamentals (7/7)");
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture3"+UserData.Username) == null){
...
//                    }
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture4"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture5"+UserData.Username) == null){
...
////                    esmQuickAnswer.setTitle("Survey about the first lecture of Cyber Communication (7/7)");
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture6"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture7"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture8"+UserData.Username) == null){
...
////                    esmQuickAnswer.setTitle("Survey about the first lecture of Information Security (7/7)");
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture9"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture10"+UserData.Username) == null){
...
////                    esmQuickAnswer.setTitle("Survey about the first lecture of Software Architecture and Design (7/7)");
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture11"+UserData.Username) == null){
...
//
//
//                    if(Scheduler.getSchedule(context, "second_post_lecture12"+UserData.Username) == null){
